...
const galleryItems: GalleryItem[] = [
  {
    ...
    year: 1511,
    description:
      "This fresco depicts the greatest philosophers of antiquity gathered together. It represents the Renaissance ideal of humanist learning.",
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/4/49/%22The_School_of_Athens%22_by_Raffaello_Sanzio_da_Urbino.jpg",
    category: "painting",
    location: "Vatican Museums",
    themeConnection:
      "Embodies the humanist right to intellectual inquiry and scholars' responsibility to preserve classical knowledge.",
  ...
  },
  {
    ...
    year: 1504,
    description:
      "This 17-foot marble statue represents David before his battle with Goliath. It symbolized Florentine civic virtue.",
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/a/a0/%27David%27_by_Michelangelo_Fir_JBU002.jpg",
    category: "sculpture",
    location: "Galleria dell'Accademia, Florence",
    themeConnection:
      "A civic symbol representing Florence's right to self-governance and citizens' responsibility to defend their republic.",
  ...
  },
  {
    ...
    year: 1519,
    description:
      "The world's most famous painting, demonstrating Leonardo's mastery of sfumato technique.",
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg",
    category: "painting",
    location: "Louvre Museum, Paris",
    themeConnection:
      "Leonardo asserted his right to perfect his work over many years rather than quickly fulfilling a commission.",
  ...
  },
  {
    ...
    year: 1512,
    description:
      "Part of the Sistine Chapel ceiling, depicting God giving life to Adam.",
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/5/5b/Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg",
    category: "painting",
    location: "Sistine Chapel, Vatican City",
    themeConnection:
      "Represents artistic genius and the responsibilities artists bore to papal patrons.",
    imageCredit: "Wikimedia Commons, Public Domain",
  },
];
